...
import com.asura.goods.client.BrandClient;
import com.asura.goods.client.CategoryClient;
import com.asura.goods.client.GoodsClient;
import com.asura.goods.client.SpecificationClient;
...
public class GoodsService {
    ...
    public Map<String,Object> loadData(Long spuId){
        ...
        //查询sku集合
        List<Sku> skus =
                this.goodsClient.querySkuBySpuId(spuId);
        ...
        for (int i=0;i<cids.size();i++){
            ...
            categoryMap.put("names",names.get(i));
